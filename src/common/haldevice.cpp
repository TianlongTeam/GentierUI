...
const QDBusArgument & QDBusArgument::operator <<( QDBusArgument &arg, const ChangeStruct &change ) {
    arg.beginStructure();
...
const QDBusArgument & QDBusArgument::operator >>( const QDBusArgument &arg, ChangeStruct &change ) {
    arg.beginStructure();
    arg >> change.propertyName >> change.added >> change.removed;
    arg.endStructure();
    return arg;
